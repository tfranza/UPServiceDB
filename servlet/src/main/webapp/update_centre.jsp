...
<div class="container">
	...
	<div class="row"> 
		<div class="col-md-12">
			<div class="page-header"><br><h3><pre> Update a Centre</pre></h3></div>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<form action="Centre" method="post">
						<input type="hidden" name="operation" value="S_update_centre">
						<div class="row">
							<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="Centre" method="post">
						<input type="hidden" name="operation" value="update_centre">
						<div class="row">
							<div class="col-md-3">
								<input type="text" name="idCentre" placeholder="Id of the centre" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="kindCentre" placeholder="Updated kind" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="addressCentre" placeholder="Updated address" class="form-control">
							</div>
		 					<div class="col-md-3" align="right">
