...
<div class="container">
	...
	<div class="row"> 
		<div class="col-md-12">
			<div class="page-header"><br><h3><pre> Delete a Vehicle</pre></h3></div>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<form action="Vehicle" method="post">
						<input type="hidden" name="operation" value="S_delete_vehicle">
						<div class="row">
							<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="Vehicle" method="post">
						<input type="hidden" name="operation" value="delete_vehicle">
						<div class="row">
							<div class="col-md-3">
								<input type="text" name="plateVehicle" placeholder="Plate of the vehicle" class="form-control">
							</div>
