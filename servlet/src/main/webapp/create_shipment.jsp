...
<div class="container">
	...
	<div class="row"> 
		<div class="col-md-12">
			<div class="page-header"><br><h3><pre> Insert a Shipment</pre></h3></div>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<form action="Shipment" method="post">
						<input type="hidden" name="operation" value="S_create_shipment">
						<div class="row">
							<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="Shipment" method="post">
						<input type="hidden" name="operation" value="create_shipment">
						<div class="row">
							<div class="col-md-3">
								<input type="text" name="destinationShipment" placeholder="Destination of the shipment" class="form-control">
							</div>
