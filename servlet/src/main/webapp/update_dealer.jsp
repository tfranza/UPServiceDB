...
<div class="container">
	...
	<div class="row"> 
		<div class="col-md-12">
			<div class="page-header"><br><h3><pre> Update a Dealer</pre></h3></div>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<form action="Dealer" method="post">
						<input type="hidden" name="operation" value="S_update_dealer">
						<div class="row">
							<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="Dealer" method="post">
						<input type="hidden" name="operation" value="update_dealer">
						<div class="row">
							<div class="col-md-3">
								<input type="text" name="idDealer" placeholder="Id of the dealer" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="kindDealer" placeholder="Updated kind" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="nameDealer" placeholder="Updated name" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="phoneDealer" placeholder="Updated phone" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="mailDealer" placeholder="Updated mail" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="zipDealer" placeholder="Updated zip" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="countryDealer" placeholder="Updated country" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="cityDealer" placeholder="Updated city" class="form-control">
							</div>
							<div class="col-md-3">
								<input type="text" name="streetDealer" placeholder="Updated street" class="form-control">
							</div>
		 					<div class="col-md-3" align="right">
