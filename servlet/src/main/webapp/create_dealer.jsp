...
<div class="container">
	...
	<div class="row"> 
		<div class="col-md-12">
			<div class="page-header"><br><h3><pre> Insert a Dealer</pre></h3></div>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<form action="Dealer" method="post">
						<input type="hidden" name="operation" value="S_create_dealer">
						<div class="row">
							<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="Dealer" method="post">
						<input type="hidden" name="operation" value="create_dealer">
						<div class="row">
							<div class="col-md-3">
								<input type="text" name="idDealer" placeholder="Id of the dealer" class="form-control">
							</div>
