...
<div class="container">
	...
	<div class="row"> 
		<div class="col-md-12">
			<div class="page-header"><br><h3><pre> Delete a Department</pre></h3></div>
		</div>
	</div>
	<hr>
	...
	<div class="card">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<form action="Department" method="post">
						<input type="hidden" name="operation" value="S_delete_department">
						<div class="row">
							<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="Department" method="post">
						<input type="hidden" name="operation" value="delete_department">
						<div class="row">	
							<div class="col-md-3">
								<input type="text" name="nameDepartment" placeholder="Name of the department" class="form-control">
							</div>
